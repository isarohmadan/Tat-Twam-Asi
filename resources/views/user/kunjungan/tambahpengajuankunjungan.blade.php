...
<div class="container-form">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control simple-input" name='nama_pengaju' id="nama_pengaju" required>
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control simple-input" name='judul_kegiatan' id="judul_kegiatan" required>
        <!-- name tetap 'judul_kegiatan' -->
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control simple-input" name='tanggal_kegiatan' id="tanggal_kegiatan" required>
                </div>
            </div>
