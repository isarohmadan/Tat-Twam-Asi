    ...
    <div class="">
        ...
        <div id="sejarah" class="row align-items-center g-5 my-5">
            ...
            <div class="col-lg-6 gsap-history-content">
                    ...
                    <p class="content-text gsap-history-text" style=" font-size: 1rem; font-family: 'Montserrat', sans-serif; text-align: right;">
        ...
        <div id="visimisi" class="row align-items-center g-5 flex justify-center mx-auto">
            <div class="row align-items-center  mb-5 flex-lg-row-reverse mx-auto p-0">
            <div class="text-center visimisiwrapper">
...
<style>
    ...
    .team-member:nth-child(even) .image-side {
        text-align: left;
    }
    #sejarah {
        width: 95vw;
