  <!-- Swiper -->
  <div class="swiper mySwiper Swiper-Other-Berita">
    <div class="swiper-wrapper">
      ...
      @forelse($beritas as $berita)
          <div class="swiper-slide">
              ...
              <div class="card shadow-sm gsap-blog-card position-relative" 
                  ...
                  @php
                      ...
                      $isNew = $berita->tanggal_publikasi->diffInDays(now()) <= 3;
                      $showBadge = $isFeatured || $isNew;
                  @endphp
                  
                  @if($showBadge)
                      <div class="position-absolute top-0 end-0 m-2" style="z-index: 10;">
                          <span class="badge {{ $loop->index == 1 ? 'bg-danger' : 'bg-primary' }} px-3 py-2 text-white" 
                                style="font-size: 0.8rem; border-radius: 50px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
                              <i class="fas {{ $loop->index == 1 ? 'fa-fire' : 'fa-star' }} me-1"></i>
                              {{ $loop->index == 1 ? 'Paling Baru!' : 'Terbaru' }}
                          </span>
                      </div>
                  @endif
                  ...
                  <div class="p-3 d-flex flex-column" style="font-family: 'Montserrat', sans-serif;">
