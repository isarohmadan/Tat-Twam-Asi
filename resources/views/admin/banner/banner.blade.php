                    ...
                    <div class="mb-4">
                        ...
                        <form action="{{ route('banners.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file @error('banner_image') is-invalid @enderror" id="banner_image" name="banner_image" required>
                                @error('banner_image')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="order" name="order" value="{{ $nextOrder }}" min="1">
                            ...
                            <tbody>
                                @foreach($banners as $index => $banner)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>
                                            <img src="{{ asset('storage/' . $banner->image_path) }}" alt="Banner Image" style="max-width: 200px; max-height: 100px;">
                                        </td>
                                        <td>{{ $banner->order }}</td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#editModal{{ $banner->id }}">
                                                Edit
                                            </button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="banner_image">New Banner Image (Leave empty to keep current)</label>
                                                            ...
                                                            <img src="{{ asset('storage/' . $banner->image_path) }}" alt="Current Banner" style="max-width: 100%;">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="order">Order</label>
                                                            <input type="number" class="form-control" id="order" name="order" value="{{ $banner->order }}" min="1">
                                                        </div>
                                                    </div>
